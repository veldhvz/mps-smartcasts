...
<model ref="r:ae1a3ca0-e482-48ac-b792-a024db401dac(nl.veldhvz.smartcasts.build)">
  ...
  <node concept="1l3spW" id="5rfTprUa0Xo">
    ...
    <node concept="m$_wf" id="5rfTprUa0XF" role="3989C9">
      ...
      <node concept="2pNNFK" id="21sjDop7BLV" role="20twgj">
        <property role="2pNNFO" value="idea-version" />
        <property role="qg3DV" value="true" />
        <node concept="2pNUuL" id="21sjDop7BM2" role="2pNNFR">
          <property role="2pNUuO" value="since-build" />
          <node concept="2pMdtt" id="21sjDop7BM3" role="2pMdts">
            <property role="2pMdty" value="212.3" />
          </node>
        </node>
        <node concept="2pNUuL" id="21sjDop7BM8" role="2pNNFR">
          <property role="2pNUuO" value="until-build" />
          <node concept="2pMdtt" id="21sjDop7BM9" role="2pMdts">
